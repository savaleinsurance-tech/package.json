export default function HomePage() {
  const box: React.CSSProperties = { border: "1px solid #e5e7eb", borderRadius: 16, padding: 24 };
  const btn = (bg: string) => ({ background: bg, color: "#fff", borderRadius: 14, padding: "10px 16px", textDecoration: "none", display: "inline-block" });
  return (
    <main>
