export default function Home() {
  ...
  return (
    <main style={{ padding: "48px", fontFamily: "system-ui, sans-serif", maxWidth: 980, margin: "0 auto" }}>
      ...
      <p style={{ fontSize: 18, color: "#374151" }}>Protegiendo lo que <strong>más valoras</strong>. Sitio en línea ✅</p>
      ...
      <p style={{ marginTop: 24, color: "#6b7280" }}>Luego reemplazamos este Home por la versión completa con secciones.</p>
    </main>
  );
}
